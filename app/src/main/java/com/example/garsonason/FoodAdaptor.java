...
public class FoodAdaptor extends ArrayAdapter<customerProductAdapter> {

    private List<customerProductAdapter> list;
    ...
    public FoodAdaptor(Context context, List<customerProductAdapter> myOrders) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
        ...
        if(listItemView == null){
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.custom1_listview,parent,false
            );
        }

        final customerProductAdapter currentFood = getItem(position);
        ...
        currentFoodName.setText(currentFood.geturunAdi());
        currentCost.setText(Integer.parseInt((currentFood.geturunFiyat())) * currentFood.getmQuantity());
